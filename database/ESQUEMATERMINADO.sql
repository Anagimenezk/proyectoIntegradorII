...
INSERT INTO productos VALUES (default, "alos.jpg", "Alo's", "2020-03-02","Este moderno bistró, que abre para el desayuno, el almuerzo y la cena, se convirtió rápidamente en un éxito por su forma única de transformar los sabores argentinos familiares.", 1);
INSERT INTO productos VALUES (default, "chila.jpeg", "Chila", "2020-03-22", "La cocina de este restaurante es en igual medidas coqueto y vanguardista. Está comandada por Pedro Bargero.", 3);
INSERT INTO productos VALUES (default, "dabbang.jpg", "Niño Gordo", "2020-05-14","Tal vez uno de los restaurantes de la lista más difíciles de encasillar. La comida tiene mucha influencia de platos y street food asiático, pero no es un restaurante asiático. Se siente bastante argentino.", 2);
INSERT INTO productos VALUES (default, "donjulio.jpg", "Don Julio", "2020-02-23", "No es fácil tomar algo tan cotidiano y popular como es la carne a la parrilla, y llevarlo a un nivel de excelencia sin precedentes y no caer en la pretensión o sobre exigencia, pero este restaurant, lo logro.", 4);
INSERT INTO productos VALUES (default, "elena.jpg", "Elena", "2020-03-02", "Elena es probablemente el lugar donde más sofisticado te sientas comiendo un bife de chorizo en Buenos Aires.", 3);
INSERT INTO productos VALUES (default, "mishiguene.jpg", "Mishiguene", "2020-06-20", "Todos los platos (además de deliciosos) tienen una historia que contar, y en general, esta se relaciona a la vida de Tomas Kalika, el cocinero, y sus raíces judías.", 5);
INSERT INTO productos VALUES (default, "mudra.jpg", "Mudra Plant Based", "2020-06-12", "Son pocos los restaurantes que logran colarse en las conversaciones gastronómicas cuando todavía no abrieron sus puertas, Mudrá es una de esas excepciones.", 1);
INSERT INTO productos VALUES (default, "nadra.jpg", "Narda Comedor", "2020-08-18", "La atención es cálida y eficiente, los platos son para compartir y el único sello que tienen es el de lo impredecible: tanto en sabores como en origen.", 4);
INSERT INTO productos VALUES (default, "proper.jpeg", "Proper", "2020-06-10", "De afuera este garage sobre calle Araoz poco te va a llevar a un restaurante en esta lista, pero todo eso se borra cuando probás el primer plato.", 2);
INSERT INTO productos VALUES (default, "tegui.jpg", "Tegui", "2020-09-28", "De afuera este garage sobre calle Araoz poco te va a llevar a un restaurante en esta lista, pero todo eso se borra cuando probás el primer plato.", 5);
INSERT INTO productos VALUES (default, "sacro.jpeg", "Sacro", "2020-10-07", "La elegante arquitectura de Sacro, atrae a la multitud vegana y carnívora en busca de platos creativos y sabrosos a base de plantas. El menú de inspiración internacional fue diseñado por el chef ejecutivo Maximiliano Rossi.", 1);
INSERT INTO productos VALUES (default, "casacavia.jpeg", "Casa Cavia", "2020-12-28", "El exclusivo restaurante judío del chef Tomás Kalika recrea platos asquenazíes, sefardíes, israelíes y del Medio Oriente utilizando ingredientes frescos y técnicas modernas de una manera que intriga y evoca nostalgia.", 3);
